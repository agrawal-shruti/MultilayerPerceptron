...
class NeuralNet:
    ...
    def predict(self, test, activation, header = True):
        ...
        X = test_dataset.iloc[:, 0:(ncols -1)].values.reshape(nrows, ncols-1)
        y = test_dataset.iloc[:, (ncols-1)].values.reshape(nrows, 1)        
        if activation == "sigmoid":
...
if __name__ == "__main__":
    ...
    for a in activation:
        ...
        neural_network.train(a)
        testError = neural_network.predict("test.csv", a)
